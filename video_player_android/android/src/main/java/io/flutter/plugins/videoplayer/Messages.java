...
public class Messages {
  ...
  public static final class UpdateMessage {
    ...
    public static final class Builder {
      ...
      public @NonNull UpdateMessage build() {
        UpdateMessage pigeonReturn = new UpdateMessage();
    ...
    static @NonNull UpdateMessage fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      UpdateMessage pigeonResult = new UpdateMessage();
  ...
  public interface AndroidVideoPlayerApi {
    ...
    void update(@NonNull UpdateMessage msg);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.update" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                UpdateMessage msgArg = (UpdateMessage) args.get(0);
                try {
                  api.update(msgArg);
                  wrapped.add(0, null);
                }
