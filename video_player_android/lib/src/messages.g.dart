...
class AndroidOptionsMessage {
  AndroidOptionsMessage({
    required this.useSoftwareDecoding,
  });
  ...
  static AndroidOptionsMessage decode(Object result) {
    result as List<Object?>;
    return AndroidOptionsMessage(
      useSoftwareDecoding: result[0]! as bool,
    );
  }
}
...
class AndroidVideoPlayerApi {
  ...
  Future<void> setAndroidOptions(AndroidOptionsMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
